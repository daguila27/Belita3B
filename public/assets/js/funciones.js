...
function item_producto(total, data, inventOrsale){
	 var new_t = parseInt(total) + parseInt(data.datos_producto.precio)*parseInt(data.datos_producto.cantidad);
     ...
     if(inventOrsale){
        ...
        comand += "<td class='ganancia' id='g" + data.id_producto + "'></td>";
     }
     else{
     	comand += "<td>$" + data.data_producto.precio + "</td>";
     }
     ...
     comand += "<td><b>Total: $" + new_t.toString() + "</b></td>";
     comand += "</tr>";
     return comand;
}
